...
from app.utilities.rule_service_util import spike_create_rules_by_entity_and_category_dict
...
def test_spike_create_rules_dict_empty_stored_rules():
    ...
    result = spike_create_rules_by_entity_and_category_dict(stored_rules, categories, entity_types)
